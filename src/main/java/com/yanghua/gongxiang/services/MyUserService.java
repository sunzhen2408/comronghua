...
public class MyUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username)
        ...
        //System.out.println(grantedAuth+"grantedAuth");
    ...
    private Set<GrantedAuthority> getGrantedAuth(Users users){
        ...
        try{
            ...
            Roles roles = roleService.findRolesFuncsByType(roleUsers.getType());
            authSet.add(new SimpleGrantedAuthority(roles.getFuncs()));
